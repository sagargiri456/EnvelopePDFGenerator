    ...
    return (
        ...
        <div className="w-full p-10 bg-blue-50  mx-auto shadow-lg rounded-lg">
            ...
            <div className="mb-6">
                ...
                <div className="flex justify-between border-b-2 w-1/6 border-black-900 space-x-2">
                    <div className="w-1/3 text-sm">M.P.</div>
                    <div className="w-2/3 text-sm">APPEAL</div>
                </div>
            ...
            <div className="mb-6 flex">
                <div className="flex">
                    <div className="mr-10">
                        <h2 className="text-lg w-4 font-semibold">Petitioner</h2>
                        <h2 className="text-lg w-4 font-semibold">Complainant</h2>
                        <h2 className="text-lg w-4 font-semibold">Appellant</h2>
                        <h2 className="text-lg w-4 font-semibold">Applicant</h2>
                    </div>
            ...
            <div className="mb-6 flex">
                <div className="flex">
                    <div className="mr-9 pr-1/2">
                        <h2 className="text-lg w-4 font-semibold">Respondent</h2>
                        <h2 className="text-lg w-4 font-semibold">Non-applicant</h2>
                        <h2 className="text-lg w-4 font-semibold">Accused</h2>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="150" height="100" viewBox="0 0 200 700">
                        <title>Closing Curly Brace</title>
                        <g className="closing_curly_bracket_image" id="closing_curly_brace_pic" transform="translate(10,10)">
...
export default MemoOfAppearance;
